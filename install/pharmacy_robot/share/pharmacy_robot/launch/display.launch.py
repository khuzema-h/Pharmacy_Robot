...
#launch generate description
def generate_launch_description():
    
    ####### DATA INPUT ##########
    urdf_file = 'pharmacy_robot.urdf'
    ...
    default_rviz_config_path = PathJoinSubstitution(
        [FindPackageShare("pharmacy_robot"), "rviz", "display_default.rviz"]
    )
    ...
    tf=Node(
        ...
        output='screen',
        arguments=['1', '0', '1', '0', '0', '0', '1', '/map',  '/dummy_link'  ],
    )
