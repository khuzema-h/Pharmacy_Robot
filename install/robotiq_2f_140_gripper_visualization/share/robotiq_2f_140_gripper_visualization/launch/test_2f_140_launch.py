...
def generate_launch_description():
    ...
    world = os.path.join(
        get_package_share_directory('robotiq_2f_140_gripper_visualization'),
        'worlds',
        'empty_world.world'
    )
    ...
    pkg_gazebo = get_package_share_directory('robotiq_2f_140_gripper_visualization')
