...
def generate_launch_description():
    ...
    ld.add_action(
        DeclareLaunchArgument(
            "robot_urdf",
            default_value=urdf,
            description="pharmacy_robot/urdf/pharmacy_gripper.xacro",
        )
    )
    ...
    spawn_entity = Node(
        ...
        arguments=[
            "-entity",
            "pharmacy_robot",  # Replace with your robot's name
            "-file",
