...
def generate_launch_description():
    ...
    ####### DATA INPUT ##########
    xacro_file = "pharmacy_robot.urdf.xacro"

    package_description = "pharmacy_robot"

    # Position and orientation for competition
    # # [X, Y, Z]
    position = [0.0, 0.0, 1.0]
    # # [Roll, Pitch, Yaw]
    orientation = [0.0, 0.0, 0.0]

    # position and orientation for proportional Controller
    # [X, Y, Z]
    ...
    # Base Name or robot
    robot_base_name = "pharmacy_robot"
    ####### DATA INPUT END ##########
    ...
    # Robot Desciption in XACRO Format
    ...
    # Publishing Robot Desciption in String form in the topic /robot_description
    publish_robot_description = Node(
        package='pharmacy_robot',
    ...
    # Launching the  Config for Simulation Time
